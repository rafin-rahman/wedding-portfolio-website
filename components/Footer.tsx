...
export default async function Example() {
  ...
  const socialLinks = [
    { name: "Instagram", href: brand.instagram, icon: "instagram" },
    { name: "TikTok", href: brand.tiktok, icon: "tiktok" },
    { name: "Facebook", href: brand.facebook, icon: "facebook" },
    { name: "LinkedIn", href: brand.linkedin, icon: "linkedin" },
    { name: "YouTube", href: brand.youtube, icon: "youtube" },
    ...
    <footer className="bg-white">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8 text-center">
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-500">
          &copy; {getCurrentYear()} {brand.companyName}
        </p>
      </div>
    </footer>
  );
...
// Separate component for rendering SVG icons
